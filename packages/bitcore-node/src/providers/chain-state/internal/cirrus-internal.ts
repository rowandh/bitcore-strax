...
@LoggifyClass
export class CirrusInternalStateProvider implements IChainStateService {
  chain: string;
  ...
  async getLocatorHashes(params) {
    ...
    if (locatorBlocks.length < 2) {
      return ['000005769503496300ec879afd7543dc9f86d3b3d679950b2b83e2f49f525856']; // Add STRAX genesis hash here
    }
